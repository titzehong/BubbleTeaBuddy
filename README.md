...
Tree based classifiers are used to detect intent of incoming user messages. To train the intent classifier user [intent_trainer.ipynb](intent_trainer.ipynb)
